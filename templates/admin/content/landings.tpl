<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">Лендинги</h3>
<div class="page-bar">
...
<div class="portlet light">
  <div class="portlet-title">
    <div class="caption">Лендинги</div>
    <div class="actions">
      <a href="/admin/groups" class="btn blue-hoki">Группы</a>
      <a href="/admin/blogs" class="btn green-meadow">Блоги</a>
      <a href="/admin/landings/new/" target="_blank" class="btn yellow-crusta add-item"><i class="fa fa-plus"></i> Новый лендинг</a>
    </div>
  </div>
  <div class="portlet-body">
    <div class="alert alert-info">
      В превью лендингов используется <strong><a href="/admin/offers/view/266" target="_blank">Тестовый оффер</a></strong>.
    </div>
    <div class="table-container ">
      <table class="table table-striped table-bordered table-hover" id="datatable_content" data-content-type="landings">
      <thead>
        ...
        <tr role="row" class="filter">
          ...
          <td>
            <select class="form-control form-filter select2me" name="group">
              <option value="-1">Группа</option>
              {foreach from=$groups item=a}
                <option value="{$a.g_id}">{$a.name}</option>
              {/foreach}
            </select>
          </td>
          <td></td>      
