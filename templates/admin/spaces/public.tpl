<h2 class="page-title">
  {if $data.id}Редактирование источника `{$data.name}`{else}Добавление источника - Социальная сеть{/if}
</h2>
...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <a href="#">{if $data.id}Редактирование источника `{$data.name}`{else}Добавление источника - Социальная сеть{/if}</a>
    </li>
  </ul>
</div>
  ...
  <div class="portlet-body">
    <form action="/admin/spaces" method="post" id="space-form">
      ...
      <div class="form-horizontal">
        <input type="hidden" name="space[type]" value="public">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="space[url]" class="form-control" placeholder="http://example.com" value="{$data.url}">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="space[source]" class="form-control select2me">
